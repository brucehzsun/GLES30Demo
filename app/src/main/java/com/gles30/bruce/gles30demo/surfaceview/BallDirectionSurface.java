...
import com.gles30.bruce.gles30demo.modle.BallAllLight;
import com.gles30.bruce.gles30demo.modle.BallDirection;
...
public class BallDirectionSurface extends GLSurfaceView {
    private final float TOUCH_SCALE_FACTOR = 180.0f / 320;//角度缩放比例
    private SceneRenderer mRenderer;//场景渲染器
    BallDirection ball;//球
    ...
    @SuppressLint("NewApi")
    public BallDirectionSurface(final Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball = new BallDirection(getContext());
            //打开深度检测
