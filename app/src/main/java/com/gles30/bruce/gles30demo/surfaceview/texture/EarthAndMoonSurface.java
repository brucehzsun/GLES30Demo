...
import com.gles30.bruce.gles30demo.modle.texture.Celestial;
import com.gles30.bruce.gles30demo.modle.texture.Earth;
import com.gles30.bruce.gles30demo.modle.texture.Moon;
...
public class EarthAndMoonSurface extends GLSurfaceView {
    ...
    public EarthAndMoonSurface(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建地球对象
            earth = new Earth(getContext(), 2.0f);
            //创建月球对象
            moon = new Moon(getContext(), 1.0f);
            //创建小星星天球对象
