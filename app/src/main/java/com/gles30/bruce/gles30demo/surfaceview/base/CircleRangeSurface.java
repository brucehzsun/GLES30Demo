...
import com.gles30.bruce.gles30demo.modle.base.CircleRangeElement;
...
public class CircleRangeSurface extends GLSurfaceView {

    public CircleRangeSurface(Context context) {
        super(context);
