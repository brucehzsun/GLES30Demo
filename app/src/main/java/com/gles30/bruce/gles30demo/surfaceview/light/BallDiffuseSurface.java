...
import com.gles30.bruce.gles30demo.modle.light.BallDiffuse;
...
public class BallDiffuseSurface extends GLSurfaceView {
    ...
    @SuppressLint("NewApi")
    public BallDiffuseSurface(final Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball = new BallDiffuse(getContext());
            //打开深度检测
