...
import com.gles30.bruce.gles30demo.modle.texture.Stairs;
import com.gles30.bruce.gles30demo.util.MatrixState;

public class StairsSuface extends GLSurfaceView {
    ...
    public StairsSuface(Context context) {
        super(context);
