...
public class Points2 {
    ...
    public Points2(Context context) {
        //调用初始化顶点数据的方法
        initVertexData();
        //调用初始化着色器的方法
        initShader(context);
    ...
    public void initShader(Context context) {
        // 加载顶点着色器的脚本内容
        String mVertexShader = ShaderUtil.loadFromAssetsFile(context, "texture/vertex_9.sh");
        // 加载片元着色器的脚本内容
        String mFragmentShader = ShaderUtil.loadFromAssetsFile(context, "texture/frag_9.sh");
        // 基于顶点着色器与片元着色器创建程序
