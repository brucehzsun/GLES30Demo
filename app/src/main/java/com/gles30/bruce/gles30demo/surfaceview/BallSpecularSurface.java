...
import com.gles30.bruce.gles30demo.modle.BallDiffuse;
...
public class BallSpecularSurface extends GLSurfaceView {
    ...
    @SuppressLint("NewApi")
    public BallSpecularSurface(final Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball = new BallSpecular(getContext());
            //打开深度检测
