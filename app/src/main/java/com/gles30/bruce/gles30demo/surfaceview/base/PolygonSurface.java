...
import com.gles30.bruce.gles30demo.modle.base.ColorRect;
import com.gles30.bruce.gles30demo.util.Constant;
import com.gles30.bruce.gles30demo.util.MatrixState;

public class PolygonSurface extends GLSurfaceView {
    ...
    public PolygonSurface(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建立方体对象
            color1 = new ColorRect(getContext(), Constant.UNIT_SIZE * 600, new float[]{0, 1, 1, 0});//蓝色
            color2 = new ColorRect(getContext(), Constant.UNIT_SIZE * 600, new float[]{1, 1, 0, 0});//黄色
            //打开深度检测
