...
public class Stairs {
    ...
    private float xSize = 0.2f;
    private float y1Size = 0.1f;
    private float y2Size = 0.2f;
    private float y3Size = 0.3f;
    private float y4Size = 0.4f;
    private float z1Size = 0.4f;
    private float z2Size = 0.3f;
    private float z3Size = 0.2f;
    private float z4Size = 0.1f;
    ...
    public void initShader(Context context) {
        //加载顶点着色器的脚本内容
        String mVertexShader = ShaderUtil.loadFromAssetsFile(context, "texture/vertex_stairs.sh");
        //加载片元着色器的脚本内容
        String mFragmentShader = ShaderUtil.loadFromAssetsFile(context, "texture/frag_stairs.sh");
        //基于顶点着色器与片元着色器创建程序
