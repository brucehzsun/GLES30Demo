...
import com.gles30.bruce.gles30demo.modle.base.Belt2;
...
public class BeltGLSurfaceView extends GLSurfaceView {

    public BeltGLSurfaceView(Context context) {
        super(context);
