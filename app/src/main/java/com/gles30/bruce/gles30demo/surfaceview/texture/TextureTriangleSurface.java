...
import com.gles30.bruce.gles30demo.modle.texture.Triangle;
import com.gles30.bruce.gles30demo.util.MatrixState;

import javax.microedition.khronos.egl.EGLConfig;
import javax.microedition.khronos.opengles.GL10;

public class TextureTriangleSurface extends GLSurfaceView {
    ...
    public TextureTriangleSurface(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建三角形对对象
            texRect = new Triangle(getContext());
            //打开深度检测
