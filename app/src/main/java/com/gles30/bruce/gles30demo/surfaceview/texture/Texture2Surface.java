...
import com.gles30.bruce.gles30demo.modle.texture.TextureRect2;
import com.gles30.bruce.gles30demo.util.MatrixState;

public class Texture2Surface extends GLSurfaceView {
    ...
    public Texture2Surface(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        TextureRect2 texRect;    //纹理矩形对象的引用
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建纹理矩形对象
            texRect = new TextureRect2(getContext());
            //打开深度检测
    ...
    private void initButton() {
        ...
        View content = LayoutInflater.from(getContext()).inflate(R.layout.text2button, null);
        ((ViewGroup) getParent()).addView(content);

        //为RadioButton添加监听器
        RadioButton rb = (RadioButton) content.findViewById(R.id.Radi01);
        ...
        rb = (RadioButton) content.findViewById(R.id.Radi02);
        rb.setOnCheckedChangeListener(
                new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        rb = (RadioButton) content.findViewById(R.id.Radi03);
        rb.setOnCheckedChangeListener(
                new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        rb = (RadioButton) content.findViewById(R.id.Radi04);
        rb.setOnCheckedChangeListener(
                new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
