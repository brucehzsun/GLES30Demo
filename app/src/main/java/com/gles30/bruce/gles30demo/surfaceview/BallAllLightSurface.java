...
import com.gles30.bruce.gles30demo.modle.BallSpecular;
...
public class BallAllLightSurface extends GLSurfaceView {
    ...
    @SuppressLint("NewApi")
    public BallAllLightSurface(final Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball = new BallAllLight(getContext());
            //打开深度检测
