package com.gles30.bruce.gles30demo.modle.light;
...
public class BallDirection {
    ...
    public BallDirection(Context context) {
        // 初始化顶点数据的方法
        initVertexData();
        // 初始化着色器的方法
        initShader(context);
    ...
    public void initShader(Context context) {
        // 加载顶点着色器的脚本内容
        String mVertexShader = ShaderUtil.loadFromAssetsFile(context, "vertex_direction.sh");
        // 加载片元着色器的脚本内容
        String mFragmentShader = ShaderUtil.loadFromAssetsFile(context, "frag_direction.sh");
        // 基于顶点着色器与片元着色器创建程序
...
//        maLightLocationLocation = GLES30.glGetUniformLocation(mProgram, "uLightLocation");
    ...
    public void drawSelf() {
        ...
        //将光源方向传入渲染管线
        GLES30.glUniform3fv(muLightDirectionHandle, 1, MatrixState.getLightPositionFloatBuffer());
        //将摄像机位置传入渲染管线
